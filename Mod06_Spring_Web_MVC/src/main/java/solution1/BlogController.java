...
public class BlogController {
	...
	/**
	 * If we're only working with JSON, we can return <code>List&lt;BlogPost&gt;</code>,
	 * but if we want to be able to return XML we'll need a wrapper.
	 * @return
	 */
	@RequestMapping(method = RequestMethod.GET)
	public BlogPostList listAll() {
	...
	public BlogPost update(@PathVariable("id") int id, @RequestBody BlogPost post) {
